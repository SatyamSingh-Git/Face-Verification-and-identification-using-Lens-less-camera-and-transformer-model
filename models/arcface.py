...
class ArcMarginProduct(nn.Module):
    ...
    def forward(self, input, label=None):
        # NOTE: @custom_fwd decorator above guarantees this runs in FP32 even inside
        # torch.cuda.amp.autocast(). A plain .float() cast is silently overridden by autocast.
        ...
        # Clamp strictly to avoid any floating-point cosine > 1 causing NaN in sqrt
        eps = 1e-7
